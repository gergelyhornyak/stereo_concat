...
StereoSubscriber::StereoSubscriber() : rclcpp::Node("stereo_concat_subscriber")
{
...
void StereoSubscriber::sync_callback(
...
void StereoSubscriber::sync_image_callback(
    const sensor_msgs::msg::CompressedImage::ConstSharedPtr &left_msg,
    const sensor_msgs::msg::CompressedImage::ConstSharedPtr &right_msg)
{
    try
...
void StereoSubscriber::timer_callback()
{
